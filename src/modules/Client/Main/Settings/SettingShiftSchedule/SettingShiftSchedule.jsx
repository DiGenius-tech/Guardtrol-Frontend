...
const SettingShiftSchedule = () => {
  ...
  useEffect(() => {
    setShift({
      ...shift,
      startTime: `${shiftStartMinutes}:${shiftStartSeconds} ${shiftStartMeridian}`,
                ...
                <li>
                  <div className="flex items-center mb-4">
                    <input
                      ...
                      name="numberOfShifts"
                      value="1"
                      onChange={(e) => handleNumberOfShiftChange(e)}
                      className="custom-success-check | text-[#22C55E] w-4 h-4 border-gray-300 focus:ring-2 focus:ring-success-100 dark:focus:ring-success-500 dark:focus:bg-success-500 dark:bg-red-700 dark:border-gray-600"
                    />
                    <label
                      htmlFor="one-shift"
                      className="cursor-pointer block ms-2  text-sm font-medium text-gray-900 dark:text-gray-300"
                    >
                      1 Shift
                    </label>
                  </div>
              ...
              <div className="col-span-12">
                ...
                <ul className="grid grid-cols-1 gap-2">
                  {listOfShifts.map((shift) => {
                    return (
                      <li key={shift.id} className="col-span-1">
