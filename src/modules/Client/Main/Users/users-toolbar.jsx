    ...
    <>
      ...
      <nav>
        ...
        <ul className="flex gap-2 text-center -mb-px flex-wrap border-b border-gray-200 dark:border-gray-700">
          ...
          <li>
            <Link
              to={`/client/reports/log`}
              className={
                (location.pathname.includes("reports/log")
                  ? `active font-semibold border-primary-500 bg-primary-500 text-white hover:border-primary-200 hover:text-white `
                  : `border-transparent `) +
                `flex items-center justify-center whitespace-nowrap p-4 text-sm font-medium first:ml-0 disabled:cursor-not-allowed disabled:text-gray-400 disabled:dark:text-gray-500   text-gray-500 hover:border-gray-300 hover:text-gray-600`
              }
            >
              Log
            </Link>
