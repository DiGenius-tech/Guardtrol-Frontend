...
useEffect(() => {
  ...
  return (
    <>
     ...
     {!verified? (<div className="min-h-80 mx-auto max-w-screen-2xl px-2 sm:px-6 lg:px-8">
        <div className="grid grid-cols-12 gap-4 sm:gap-8 mx-auto px-2 sm:px-6 lg:px-8">
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-4">
            ...
            <p className="text-center">
              Enter the 6 Digits Code that was sent to your email address <b>{auth.user.email}</b>
            </p>
