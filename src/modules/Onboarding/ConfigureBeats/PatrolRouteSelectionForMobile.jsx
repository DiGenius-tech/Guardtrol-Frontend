...
import PointModalMobile from "./PointModalMobile";
...
const routeList = [
  {
    ...
    address:
      "No 14 Modupe Shitta street, Off Liasu Road close to Synagogue Church, Lagos 100265",
    point: "point-1",
  ...
  return (
    <>
      ...
      <div id="configure-patrol-route-action">
        <button
          type="button"
          className="flex items-start gap-2 w-full my-10"
          onClick={() => setOpenModal(!openModal)}
        >
          <span>
            <span className="flex flex-col justify-center items-start">
              <span className="flex w-full font-semibold">Patrol route </span>
              <span className="flex w-full text-dark-300 mt-1">
                Configure the patrol route
              </span>
            </span>
          </span>
        </button>
