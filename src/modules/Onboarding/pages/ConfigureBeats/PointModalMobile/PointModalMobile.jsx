...
const PointModal = () => {
    ...
    return (
        <>
            ...
            <button data-modal-target="static-modal" data-modal-toggle="static-modal"  type='button' onClick={() => setOpenModal(true)} className='flex mx-auto underline text-base font-normal text-primary-500 hover:text-secondary-500'>View the points</button>
