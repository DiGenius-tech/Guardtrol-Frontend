...
const ConfigureBeats = () => {
    ...
    return (
        <>
            ...
            <h1 className="font-bold text-center text-2xl text-dark-450">Configure Beat</h1>
            ...
            <div className="mx-auto max-w-[500px] my-16">
                <form>
                    ...
                    <div className="shadow-md border-gray-300 text-sm rounded-2xl  block w-full p-4 sm:p-12 ">
                        ...
                        <p className="text-center font-semibold text-xl text-dark-400">Scan this QR Code with your mobile device to configure the patrol route</p>


                        {/* Success message: toogle the "hidden" class on the container to hide or show the message*/}
                        <div className="relative overflow-x-auto mt-8 text-md"> { /**container */}
                            <table className="w-full text-left rtl:text-left dark:text-gray-400">
                                <thead className="dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        <th scope="col" className="px-6 py-3 rounded-s-lg text-center text-base font-semibold" colSpan={2}>
