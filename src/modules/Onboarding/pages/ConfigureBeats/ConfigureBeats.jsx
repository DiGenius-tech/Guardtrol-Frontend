      ...
      <div className="mx-auto max-w-[500px] my-16">
        <form>
          ...
          <div id="configure-patrol-route-action">
            <button type="button" className="flex items-start gap-2 w-full">
              <span className="flex flex-col justify-center items-start">
                <span className="flex w-full">Patrol route</span>
                <span className="flex w-full">Configure the patrol route</span>
              </span>
            </button>
          </div>
            ...
            {!saveBeatData ? (
              <div className="flex flex-col">
                ...
                <div className="inline-flex mx-auto mb-8">
                  <QRGenerator text={text} qr_code_size={170} />
                </div>
