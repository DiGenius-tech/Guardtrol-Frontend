...
const OnboardingComplete = () => {
    ...
    return (
        <div>
            ...
            Congratulations!!! You Have Successfully Completed Your On-Boarding Process 
            </p>

            <div className="mx-auto max-w-[500px] my-16">
                <div className="min-h-96 flex place-content-center flex-col">

                    <div ref={tick_icon_ref} className="tick-icon | hide relative inline-flex mx-auto mb-12">
                        {/* <!-- tick circle --> */}
                        <div>
                        ...
                        <div className="tick-animate-wrap | absolute top-8 start-6">
                            <svg className="tick-animate mx-auto" width="61" height="37" viewBox="0 0 61 37" fill="none"
