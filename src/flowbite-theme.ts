...
export const customTheme: CustomFlowbiteTheme = {
  ...
  table: {
    root: {
      ...
      shadow:
        "absolute left-0 top-0 -z-10 h-full w-full rounded-lg bg-white sm:drop-shadow-md dark:bg-black",
  ...
  tabs: {
    ...
    tablist: {
      ...
      styles: {
        ...
        underline:
          "-mb-px flex-nowrap border-b border-gray-200 dark:border-gray-700 text-[#7B828E]",
        pills:
