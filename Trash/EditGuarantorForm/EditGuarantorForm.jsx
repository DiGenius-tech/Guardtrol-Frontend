...
import TextInputField from "../../src/modules/Sandbox/InputField/TextInputField";
import RegularButton from "../../src/modules/Sandbox/Buttons/RegularButton";
import SelectField from "../../src/modules/Sandbox/SelectField/SelectField";
const titleOptions = [
  {
    name: "Type one",
    value: "typeOne",
  ...
  return (
    <>
      ...
      <ol className="flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
        <li
          className={
            (stepperMargin === 0 || stepperMargin > 0
        ...
        >
          <span className="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
            {stepperMargin === 100 || stepperMargin > 100 ? (
              <svg
        ...
        >
          <span className="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
            {stepperMargin === 200 || stepperMargin > 200 ? (
              <svg
                className="w-3.5 h-3.5 sm:w-4 sm:h-4 me-2.5"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mx-auto max-w-xl">
              <fieldset>
                ...
                <RegularButton
                  text="Next"
                  type="button"
                  onClick={() => handleNextStep(BTN.PERSONAL_INFO)}
                />
              </fieldset>
            </div>
          </li>
            ...
            <div className="mx-auto max-w-xl">
              <fieldset>
                ...
                <RegularButton
                  text="Next"
                  type="button"
                  onClick={() => handleNextStep(BTN.WORK_INFO)}
                />
              </fieldset>
            </div>
          </li>
            ...
            <div className="mx-auto max-w-xl">
              <fieldset>
                ...
                <RegularButton
                  text="Complete"
                  type="button"
                  onClick={() => handleNextStep(BTN.IDENTIFICATION)}
                />
              </fieldset>
            </div>
          </li>
